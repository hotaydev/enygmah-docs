...
import { PricingCheckIcon } from "@site/src/enygmah-theme/icons/pricing-check";
import { PricingTimesIcon } from "@site/src/enygmah-theme/icons/pricing-times";
import { PricingRainbowButton } from "@site/src/enygmah-theme/pricing-rainbow-button";
import {
  PricingAirtableIcon,
  PricingAntdIcon,
  PricingAuth0Icon,
  ...
  PricingSupabaseIcon,
  PricingTwilioIcon,
} from "@site/src/enygmah-theme/icons/pricing";
import { TinyArrowLeft } from "@site/src/enygmah-theme/icons/tiny-arrow-left";
  ...
  return (
    <div
      className={clsx(
        ...
        "pb-4",
        "pt-6",
        "bg-enygmah-pricing-table-alt",
        "dark:bg-enygmah-pricing-table-alt-dark",
        "border-b",
        "border-b-gray-200",
...
function Pricing() {
  ...
  return (
    <>
      ...
      <CommonLayout
        title={"enygmah | Build your React-based CRUD applications, without constraints!"}
        description="enygmah offers lots of out-of-the box functionality for rapid development, without compromising extreme customizability. It ships with Ant Design, an enterprise-level UI toolkit."
      >
