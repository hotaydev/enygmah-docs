...
export const EnygmahWeekIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    width="40"
    height="40"
    viewBox="0 0 40 40"
  ...
  >
    <rect
      ...
      rx="20"
      fill="currentColor"
      className="text-white dark:text-enygmah-indigo-alt/10"
    />
    <rect
      width="40"
      height="40"
      rx="20"
      fill="currentColor"
      className="text-enygmah-indigo-alt"
      fillOpacity="0.1"
    />
    <path
      ...
      className="dark:text-enygmah-indigo-alt text-enygmah-indigo"
      fill="currentColor"
    />
    <path
