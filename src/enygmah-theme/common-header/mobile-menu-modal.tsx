      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <EnygmahLogoIcon
                className="dark:text-gray-0 text-gray-900 w-[124px]"
              />
              <button
                type="button"
                className={clsx(
...
const Github = (props: { id?: string }) => {
  return (
    <Link to="https://github.com/hotaydev/enygmah" className="no-underline">
      <div
        className={clsx(
      ...
      >
        ...
        >
                    If you like enygmah, don&apos;t forget to star us on GitHub!
        </div>
      </div>
    </Link>
  );
