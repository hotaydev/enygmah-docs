  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        noise: "url(/img/general-replaceable-images/landing-noise.webp)",
        "selected-tab-light":
        ...
        "landing-hero-mobile-animation-bg":
                    "url('/img/general-replaceable-images/hero-mobile-animation.svg')",
        "landing-video-bottom-mobile-bg":
                    "url('/img/general-replaceable-images/hero-video-bottom-mobile.svg')",
        "landing-video-bottom-line":
                    "url('/img/general-replaceable-images/landing-video-bottom-line.svg')",
        "landing-video-bottom-line-glow":
                    "url('/img/general-replaceable-images/landing-video-bottom-line-glow.svg')",
        ...
        "landing-planar-grid":
                    "url('/img/general-replaceable-images/landing-planar-grid.svg')",
        "landing-planar-grid-reversed":
                    "url('/img/general-replaceable-images/landing-planar-grid-reversed.svg')",
        "landing-planar-grid-mobile":
                    "url('/img/general-replaceable-images/landing-planar-grid-mobile.svg')",
        "landing-planar-grid-reversed-mobile":
                    "url('/img/general-replaceable-images/landing-planar-grid-reversed-mobile.svg')",
        ...
        "landing-tile-grid-bg":
                    "url('/img/general-replaceable-images/landing-tile-grid.svg')",
        "landing-tile-grid-mobile-bg":
                    "url('/img/general-replaceable-images/landing-tile-grid-mobile.svg')",
        "landing-stats-bg": [
        ...
        "landing-playground-slide-left-bg":
                    "url('/img/general-replaceable-images/landing-playground-slide-left.svg')",
        "landing-playground-slide-right-bg":
                    "url('/img/general-replaceable-images/landing-playground-slide-right.svg')",
